...
const LeaderboardsPage = ({ userProfile }) => {
  ...
  const fetchLeaderboardData = async () => {
    ...
    try {
      const response = await axios.get(
        `${config.base_url}/api/guest/getleaderboard?searchQuery=${searchQuery}`
      );
  ...
  return (
    <div className="ForumsPage">
      ...
      >
        ...
        <div className="searchleaderboardbuttonswrapper">
          <div
            className={` ${
              userProfile && userProfile.leaderboard
      ...
      <div className="searchleaderboards-results">
        {loading ? (
          <Loading />
        ) : (
          <div className="entries-wrapper">
            {Array.isArray(leaderboardData) && leaderboardData.length === 0 ? (
              ...
              leaderboardData.map((entry) => (
                <a key={entry.id} href={`/Profile/${entry.user.username}`}>
                  <div key={entry.id} className="entries-leaderboard">
                    ...
                    <div className="entry-score">
                      {" "}
                      <div>
                        {entry.won} <span className="green">WON</span>
                      </div>
                      <div>
                        {" "}
                        {entry.lost} <span className="red">LOST</span>
                      </div>{" "}
                      <div>
                        {entry.points}{" "}
                        <svg
